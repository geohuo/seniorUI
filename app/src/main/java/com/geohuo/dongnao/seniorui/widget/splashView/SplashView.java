package com.geohuo.dongnao.seniorui.widget.splashView;
...
/*
*可以定制的属性
* 1 小圆半径mRotationRadius
* 2 大圆半径mCircleRadius
* 3 大小圆旋转时间mRotationDuration
* 4 整体背景色mSplashBgColor
*
*
* */
...
public class SplashView extends View {
    ...
    private int[] mCircleColors = {0xFF9600,0x02D1AC,0xFFD200,0x00C6FF,0x00E099,0xFF3892,};
    // 大圆和小圆旋转的时间
...
//            mAnimator.end();
    ...
    private void drawCircles(Canvas canvas) {
        ...
        if (mCircleColors!= null){
            colorCount= mCircleColors.length;
        }

        rotationAngle = (float) (2*Math.PI/colorCount);
    ...
    private void drawBackground(Canvas canvas) {
        if(mHoleRadius>0f){
            ...
            float strokeWidth = 2f*mDiagonalDist - mHoleRadius*2f;
            mPaintBackground.setStrokeWidth(strokeWidth);
            //画圆的半径 = 空心圆的半径 + 画笔的宽度/2
           // float radius = mHoleRadius + strokeWidth/2;
            float radius = mDiagonalDist;
