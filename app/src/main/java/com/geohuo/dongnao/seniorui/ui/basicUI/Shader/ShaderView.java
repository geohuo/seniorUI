...
/**
 * Created by geohuo on 2017/7/14.
 */
...
public class ShaderView extends View {
    ...
    private ShowType type = ShowType.BitmapShader;

    public enum ShowType {
        BitmapShader, ShapeDrawable, SweepGradient, ComposeShader, LinearGradient, RadialGradient, drawStar;
    }
    ...
    private void init() {
        //mBitMap = ((BitmapDrawable)getResources().getDrawable(R.mipmap.xyjy3)).getBitmap();
    ...
    public void drawShapeDrawable(Canvas canvas) {
    ...
    public void drawLinearGradient(Canvas canvas) {
